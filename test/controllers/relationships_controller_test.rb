...
class RelationshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relationship" do
    assert_difference("Relationship.count") do
      post relationships_url, params: { relationship: { active: @relationship.active, relationship_type: @relationship.relationship_type } }
    end
  ...
  test "should update relationship" do
    patch relationship_url(@relationship), params: { relationship: { active: @relationship.active, relationship_type: @relationship.relationship_type } }
