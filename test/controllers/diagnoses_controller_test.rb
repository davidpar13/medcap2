...
class DiagnosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnosis" do
    assert_difference("Diagnosis.count") do
      post diagnoses_url, params: { diagnosis: { code: @diagnosis.code, display: @diagnosis.display, title: @diagnosis.title } }
    end
  ...
  test "should update diagnosis" do
    patch diagnosis_url(@diagnosis), params: { diagnosis: { code: @diagnosis.code, display: @diagnosis.display, title: @diagnosis.title } }
